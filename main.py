...
<<<<<<< HEAD
# Importamos las utilidades que hemos separado
...
from utils.theme_utils import ThemeManager, create_tooltip
=======
...
<<<<<<< HEAD
        # Inicializamos el gestor de temas
        self.theme_manager = ThemeManager(root)
        self.text_config = self.theme_manager.get_text_config()
...
<<<<<<< HEAD
        ...
        ttk.Button(file_frame, text="Seleccionar archivo", command=self.seleccionar_archivo, 
                  style="Primario.TButton").pack(side=tk.LEFT, padx=5)
        
        ttk.Button(file_frame, text="Generar caso aleatorio", command=self.generar_caso_aleatorio,
                  style="Secundario.TButton").pack(side=tk.LEFT, padx=5)
=======
...
<<<<<<< HEAD
        self.txt_red = scrolledtext.ScrolledText(red_frame, wrap=tk.WORD, height=10)
...
<<<<<<< HEAD
        alg_frame.columnconfigure(0, weight=1)
        alg_frame.columnconfigure(1, weight=1)
        alg_frame.columnconfigure(2, weight=1)
        
        # Botones de algoritmos con estilos personalizados
        btn_fb = ttk.Button(alg_frame, text="Fuerza Bruta", command=self.ejecutar_fuerza_bruta, 
                           style="Primario.TButton")
        btn_fb.grid(row=0, column=0, padx=5, pady=5, sticky="ew")
        create_tooltip(btn_fb, "Ejecuta el algoritmo de fuerza bruta (puede ser lento para redes grandes)")
        
        btn_voraz = ttk.Button(alg_frame, text="Voraz", command=self.ejecutar_voraz, 
                              style="Primario.TButton")
        btn_voraz.grid(row=0, column=1, padx=5, pady=5, sticky="ew")
        create_tooltip(btn_voraz, "Ejecuta el algoritmo voraz (rápido pero puede no ser óptimo)")
        
        btn_pd = ttk.Button(alg_frame, text="Programación Dinámica", command=self.ejecutar_pd, 
                           style="Primario.TButton")
        btn_pd.grid(row=0, column=2, padx=5, pady=5, sticky="ew")
        create_tooltip(btn_pd, "Ejecuta el algoritmo de programación dinámica (balance entre eficiencia y optimalidad)")
=======
        for i in range(3):
...
<<<<<<< HEAD
        self.txt_resultados = scrolledtext.ScrolledText(res_frame, wrap=tk.WORD, height=10)
...
<<<<<<< HEAD
        ttk.Button(save_frame, text="Guardar resultado", command=self.guardar_resultado,
                  style="Acento.TButton").pack(side=tk.LEFT, padx=5)
        
        ttk.Button(save_frame, text="Comparar algoritmos", command=self.comparar_algoritmos,
                  style="Secundario.TButton").pack(side=tk.LEFT, padx=5)
        
        # Statusbar
        self.statusbar = ttk.Label(main_frame, text="Listo", relief=tk.SUNKEN, anchor=tk.W)
=======
        create_button(
            save_frame, 
            "Guardar resultado", 
...
<<<<<<< HEAD
        self.text_config = self.theme_manager.toggle_theme()
        self.txt_red.configure(**self.text_config)
        self.txt_resultados.configure(**self.text_config)
        self.statusbar.config(text=f"Tema cambiado a: {self.theme_manager.current_theme}")
=======
...
>>>>>>> fe24288 (GUI Mejorada)
    ...
    def generar_caso_aleatorio(self):
        ...
        try:
<<<<<<< HEAD
            n = simpledialog.askinteger("Generar caso", "Número de grupos:", minvalue=1, maxvalue=100)
=======
